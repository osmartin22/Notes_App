...
public class UpdateNoteAsyncOldVersion extends AsyncTask<Void, Void, Void> {
    ...
    public UpdateNoteAsyncOldVersion(DatabaseHandler db, List<SingleNote> list, SingleNote note,
